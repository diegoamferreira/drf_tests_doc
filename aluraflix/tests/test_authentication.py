...
class AuthenticationUserTestCase(APITestCase):
    ...
    def test_requisicao_get_com_user_autenticado(self):
        """Verifica que uma requisição get de um user autenticado passe"""
